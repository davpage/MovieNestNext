...
export default function Header({
    ...
    return (
        <header className="w-full flex justify-center">
            <div className='max-w-[90%] rounded-full mt-2 flex flex-col items-center sticky top-0 z-40 border-b  border-gray-800
                ...
                {/* Gradient divider */}
                {/*<div className="h-[1px] w-[95%] bg-gradient-to-r from-brand-500/40 via-accent-400/40  to-flame-400/40"/>*/}
